...
learner(Num_accepted, R_lcl, V_lcl, Maj) ->
    ...
    receive
        ...
        case Msg of
            {accepted, R, Value} ->
            io:format("Learner received accepted msg~n"),
                if
                    (R > R_lcl) ->
                        io:format("New value"),
...
test1() ->
    ...
    Proposer = spawn(paxos, start_proposer, [23, [Acceptor1, Acceptor2, Acceptor3]]),
    nothing.
